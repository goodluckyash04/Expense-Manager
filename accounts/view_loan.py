...
#     #     return render(request, 'loan/addLoan.html', {'user': user, "loanData": loanData})
#
#     Loan.objects.create(
...
#     loanData = get_loan_data(user)
#     return render(request, 'loan/loanHome.html', {'loanData': loanData, 'user': user})
#
# @auth_user
...
#
#     return render(request, 'loan/loanReport.html', {'user': user, 'loanData': loanData, 'emiData': emiData, 'total': math.ceil(total)})
# @auth_user
# def searchLoan(request, user):
#     search_query = request.GET.get('search', '')
#     loanData = Loan.objects.filter(title__icontains=search_query).order_by(F("status").desc())
#     return render(request, 'loan/loanHome.html', {'user': user, "loanData": loanData})
#
# @auth_user
...
#     return render(request, 'loan/deletedEntries.html', {"data": deleteEmi, "user": user})
