...
#         payment_for = request.POST.get("payment_for", "Self").title()
...
#
#         return render(request, "transaction/transactionDetail.html", {
#             "user": user,
...
#         return render(request, 'transaction/deletedTransactions.html', {"data": deletePay, "user": user})
#     except Exception as e:
#         messages.error(request, f"An error occurred: will get back soon")
#         return redirect('reports')
#
